...
import { FolderIcon, FolderAddIcon, XIcon } from '@heroicons/react/outline';
import PanelCustomerProjectAdd from './PanelCustomerProjectAdd';
import { LoadingPanelChild } from '../../common/Loading';

const PROJECTS_QUERY = gql`
  query GetProjects($filters: ProjectFiltersInput, $customerId: ID) {
...
export default function PanelCustomerProjects() {
